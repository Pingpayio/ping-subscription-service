...
import { setKey, getImplicit, getAccount, contractCall, contractView, getBalance } from './utils/near-provider.js';
...
app.post('/api/subscription', async (c) => {
  try {
    ...
    switch (action) {
      case 'create':
        const { merchantId, amount, frequency, maxPayments, tokenAddress } = params;
        ...
        return c.json({ success: true, subscriptionId: result.subscription_id });
