  ...
  return (
    <div className="bg-[#100713] flex w-full max-w-[665px] flex-col items-stretch mt-8 md:mt-[66px] py-[5px] rounded-lg px-4 md:px-0">
      ...
      <div className="w-full flex mt-[25px]">
        <TabContent activeTab={activeTab} tab="supply" position="left">
          Always receive your preferred asset. Accept universal crypto payments
          with zero custody, instant peer-to-peer payments, and drastically
          lower fees.
        </TabContent>

        <TabContent activeTab={activeTab} tab="borrow" position="right">
          Pay Your Way. Removing the complexity and friction of different
          currencies, blockchains or wallets. Global payments made simple with
          the power of Ping.
        </TabContent>
      </div>
    </div>
